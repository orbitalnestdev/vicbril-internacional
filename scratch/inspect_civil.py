...
import re
ids = ['unipolar-pvc', 'unipolar-lsoh', 'bipolar-vaina-chata', 'bipolar-paralelo', 'bipolar-paralelo-parlante', 'civil-03']
output = []
for prod_id in ids:
...
with open('scratch/civil_dump.txt', 'w', encoding='utf-8') as f_out:
    f_out.write("".join(output))
print("Wrote dump to scratch/civil_dump.txt")
