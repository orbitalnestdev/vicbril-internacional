                ...
                {nextLevelFolders.map((sub, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-full aspect-[4/3] sm:aspect-[16/11] overflow-hidden relative bg-white flex items-center justify-center p-1">
                        <img
                          src={folderImage}
                          alt={sub}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
                {visibleProducts.map(product => (
                  ...
                  >
                    ...
                    <div
                      className="w-full aspect-[4/3] sm:aspect-[16/11] relative overflow-hidden bg-white flex items-center justify-center p-1 cursor-pointer"
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-wrap gap-2">
                          {product.specs && product.specs.map((spec, i) => (
                            <span key={i} className="text-[10px] bg-gray-100 text-gray-600 px-2 py-1 font-medium">{spec}</span>
                          ))}
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            onClick={() => handleProductClick(product)}
                            className="bg-gray-100 text-slate-900 text-[10px] font-bold py-4 hover:bg-gray-200 transition uppercase tracking-widest"
                          >
                            Ver Detalles
                          </button>
                          <button
