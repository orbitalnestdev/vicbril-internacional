              ...
              <div className="space-y-8">
                 <div className="flex items-start group">
                    ...
                    <div>
                       ...
                       <p className="text-slate-400 text-sm mt-1 leading-relaxed">
                          Parque Industrial Norte, Nave 4<br/>
                          Calle Industrial 100, CDMX, 55000
                       </p>
                    </div>
                 </div>
                 ...
                 <div className="flex items-start group">
                    ...
                    <div>
                       ...
                       <p className="text-slate-400 text-sm mt-1">
                          +52 (55) 1234-5678 (Conmutador)<br/>
                          +52 (55) 8765-4321 (Ventas)
                       </p>
                    </div>
                 </div>
                 ...
                 <div className="flex items-start group">
                    ...
                    <div>
                       ...
                       <p className="text-slate-400 text-sm mt-1">
                          ventas@vicbril.com<br/>
                          licitaciones@vicbril.com
                       </p>
                    </div>
                 </div>
              </div>
           ...
           <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 ...
                 <div className="group">
                    ...
                    <input type="tel" className="w-full border-b border-gray-300 py-3 focus:border-orange-600 focus:outline-none transition-colors bg-transparent text-slate-900 placeholder-slate-300" placeholder="(55) 0000 0000" />
                 </div>
              </div>
