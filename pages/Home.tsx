        ...
        <div className="container mx-auto px-6 z-10 relative pt-20">
          <div className="max-w-4xl">
            <div className="flex items-center space-x-4 mb-8">
               ...
               <span className="text-orange-500 text-xs font-bold tracking-[0.3em] uppercase">Distribución Mayorista B2B</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-oswald text-white leading-[0.9] mb-8 tracking-tight">
              ENERGÍA <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-500">SEGURA</span><br />
              PARA LA INDUSTRIA
            </h1>
            
            <p className="text-lg md:text-xl text-slate-300 mb-12 leading-relaxed max-w-xl font-light border-l-2 border-slate-700 pl-6">
              Suministramos conductores eléctricos de alta especificación con la logística más confiable de México. Más de 25 años respaldando grandes proyectos.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-gray-100 pb-8">
            <div className="max-w-xl">
              ...
              <p className="text-slate-500 leading-relaxed">Optimizamos la cadena de suministro para contratistas y distribuidores, asegurando que el material llegue a obra con la certificación requerida.</p>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
           <div className="text-center max-w-2xl mx-auto mb-16">
              <span className="text-orange-600 text-xs font-bold tracking-widest uppercase mb-4 block">Alta Especificación</span>
