      ...
      <div className="pt-20">
         ...
         <div className="bg-slate-900 py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
               <span className="text-orange-500 text-xs font-bold tracking-[0.4em] uppercase mb-4 block">Nuestra Esencia</span>
               <h1 className="text-5xl md:text-6xl font-oswald font-bold text-white mb-6">MÁS QUE DISTRIBUIDORES,<br />SOCIOS ESTRATÉGICOS</h1>
            ...
            <div className="container mx-auto px-6">
               <div className="flex flex-col md:flex-row gap-16 items-center">
                  ...
                  <div className="w-full md:w-1/2">
                     <h2 className="text-4xl font-oswald font-bold text-slate-900 mb-8">TRAYECTORIA Y COMPROMISO</h2>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                     ...
                     <div key={idx} className="bg-white p-10 shadow-sm border border-gray-100 hover:shadow-xl transition-shadow duration-300 border-t-4 border-t-slate-900 hover:border-t-orange-600 group">
                        ...
                        <h3 className="text-2xl font-oswald font-bold text-slate-900 mb-4">{item.title}</h3>
         ...
         <section className="py-20 bg-slate-900 text-white border-b-8 border-orange-600">
            <div className="container mx-auto px-6 text-center">
               <h3 className="text-sm font-bold tracking-[0.3em] uppercase mb-12 text-slate-500">Sectores Estratégicos</h3>
               <div className="grid grid-cols-2 md:grid-cols-4 gap-8 opacity-50">
                  <div className="border border-slate-700 p-6 flex items-center justify-center hover:bg-white hover:text-slate-900 hover:border-white transition-all cursor-default">
                     <span className="font-oswald text-2xl font-bold">MINERÍA</span>
                  </div>
                  <div className="border border-slate-700 p-6 flex items-center justify-center hover:bg-white hover:text-slate-900 hover:border-white transition-all cursor-default">
                     <span className="font-oswald text-2xl font-bold">ENERGÍA</span>
                  </div>
                  <div className="border border-slate-700 p-6 flex items-center justify-center hover:bg-white hover:text-slate-900 hover:border-white transition-all cursor-default">
                     <span className="font-oswald text-2xl font-bold">AUTOMOTRIZ</span>
                  </div>
                  <div className="border border-slate-700 p-6 flex items-center justify-center hover:bg-white hover:text-slate-900 hover:border-white transition-all cursor-default">
                     <span className="font-oswald text-2xl font-bold">CONSTRUCCIÓN</span>
                  </div>
               </div>
            </div>
         </section>
