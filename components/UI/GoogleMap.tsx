            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    <div className="w-full md:w-1/3">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-oswald font-bold text-slate-900 mb-6">ESTRATÉGICAMENTE UBICADOS</h2>
                        <p className="text-slate-500 leading-relaxed mb-8 text-lg sm:text-xl">
                        ...
                        <div className="space-y-4 text-slate-700">
                            <div className="flex items-start space-x-3">
                                ...
                                <p className="text-base sm:text-lg">San Salvador de Jujuy 1305, Lote 219. Polo Industrial Spegazzini.</p>
                            </div>
                            <div className="flex items-start space-x-3">
                                <div className="mt-2 flex-shrink-0 w-2 h-2 rounded-full bg-orange-600"></div>
                                <p className="text-base sm:text-lg">Carlos Spegazzini, Buenos Aires, Argentina</p>
                            </div>
                        </div>
                    </div>

                    <div className="w-full md:w-2/3 h-[320px] sm:h-[400px] md:h-[450px] relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
                        <iframe
